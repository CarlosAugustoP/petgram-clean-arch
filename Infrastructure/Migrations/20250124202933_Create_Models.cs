    ...
    public partial class Create_Models : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersUsers", x => new { x.FollowersId, x.FollowingId });
                    table.ForeignKey(
                        name: "FK_UsersUsers_Users_FollowersId",
                        column: x => x.FollowersId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsersUsers_Users_FollowingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersUsers_FollowingId",
                table: "UsersUsers",
                column: "FollowingId");
        }
